...
If you write no constraint, you must write `any` explicitly --- there is no implicit "unconstrained."
...
3. **Calculation:** The function below has the signature `func Reduce[T, U any](s []T, init U, f func(U, T) U) U`.
