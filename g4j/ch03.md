...
Until it acquires a type, though, it is an untyped integer constant and participates in expressions like any other untyped integer --- so `'A' + 1` is the perfectly legal constant `66`.
