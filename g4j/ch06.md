...
Chapter 2 introduced `&` and pointers; a value is addressable when you could legally apply `&` to it, which is why a bare function return value does not qualify.
:::
