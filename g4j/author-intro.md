...
the language different enough from both Java and C++ that i didn't feel comfortable in it.
also, it's was on the wrong side of the tabs-vs-spaces war --- tabs? really?!?
...
it has the garbage collection of C.
it also has the concepts of pointers from C without the complication of pointer arithmetic.
it's approach to objects are much simpler than C++ and even Java.
