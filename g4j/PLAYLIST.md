...
- Darude --- platinum single count (used in fmt.Printf example)
...
- Beyoncé --- "Texas Hold 'Em" (used in Try It)
- Harry Styles --- "Watermelon Sugar" (exercise 2 missing-key lookup)
...
- Sabrina Carpenter --- "Espresso" / Billie Eilish --- "Birds of a Feather" (Try It sort.Interface table rows; repeats from ch07)
- Chappell Roan --- "Good Luck, Babe!" (Try It sort.Interface table row)
- "sabor a mí" --- Spanish phrase used in the any/interface example
...
- Bizarrap & Quevedo --- "Quédate" (BZRP Music Sessions #52; used in Try It findBPM catalog map)
...
- Kylie Minogue --- "Padam Padam" (used in Try It timeout example tracks slice)
...
- Darude --- "Sandstorm" (used as module name reference in go.mod example and in the Try It tracks.txt)
- Robert Dream House & Miles Stone --- "Children" (used as module name in exercise 6 multi-package project; abbreviated to "Robert Dream House" in code)
- DJ Cobra --- "Better Off Alone" (used in exercise 5 module name, the /v2 module path example, and the Try It tracks.txt)
